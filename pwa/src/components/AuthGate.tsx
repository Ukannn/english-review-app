...
export function AuthGate({ demo, children }: { demo: boolean; children: ReactNode }) {
  ...
  if (!hasSupabaseConfig) return <main className="auth-shell"><section className="auth-card glass-card" role="alert"><h1>学习空间暂不可用</h1><p>此站点尚未完成连接配置，请联系维护者。</p></section></main>;
