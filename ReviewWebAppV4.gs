...
function updateConfigV4_(ss) {
  upsertConfigRowsV4_(ss, [
    ...
    ['ai_transport', 'ChatGPT task + Google Sheet staging; no OpenAI API', 'ChatGPT writes only Session Questions and Grade Inbox.'],
    ...
    ['context_processing_command', '整理语料', 'ChatGPT stages zero to three reusable chunks per pending Context.'],
...
function updateReadmeV4_(ss) {
  ...
  sheet.getRange('A1:C18').setValues([
    ...
    ['Context Candidate Inbox', 'AI staging for context-derived chunks', 'User acceptance is required before Apps Script writes Candidate Bank.'],
